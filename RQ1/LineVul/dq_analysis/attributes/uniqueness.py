...
def identify_duplicates(dataset):
    ...
    # Move the output
    p = subprocess.Popen(f"mv near-duplicate-code-detector/DuplicateCodeDetector/DuplicateCodeDetector.csproj dq_analysis/datasets/{dataset}/unique_clusters.csv", shell=True)
    p.wait()
...
if __name__ == '__main__':
    ...
    if sys.argv[1] == 'prepare':
        ...
        count_near_unique(sys.argv[2], 3)
    else:
